# AGENTS.md — DataForge Project Guide for AI Coding Agents

This file defines the project scope, architecture, and non-negotiable constraints for any AI agent (Codex, Claude Code, Cursor, Copilot, etc.) working in this repository. Read this fully before making any change.
