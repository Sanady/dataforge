...
class CryptoProvider(BaseProvider):
    ...
    def md5(self) -> str: ...
    @overload
    def md5(self, count: Literal[1]) -> str: ...
    @overload
    def md5(self, count: int) -> str | list[str]: ...
    ...
    def sha1(self) -> str: ...
    @overload
    def sha1(self, count: Literal[1]) -> str: ...
    @overload
    def sha1(self, count: int) -> str | list[str]: ...
    ...
    def sha256(self) -> str: ...
    @overload
    def sha256(self, count: Literal[1]) -> str: ...
    @overload
    def sha256(self, count: int) -> str | list[str]: ...
