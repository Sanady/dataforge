...
class GovernmentProvider(BaseProvider):
    ...
    def ssn(self) -> str: ...
    @overload
    def ssn(self, count: Literal[1]) -> str: ...
    @overload
    def ssn(self, count: int) -> str | list[str]: ...
    ...
    def tax_id(self) -> str: ...
    @overload
    def tax_id(self, count: Literal[1]) -> str: ...
    @overload
    def tax_id(self, count: int) -> str | list[str]: ...
    ...
    @overload
    def passport_number(self, count: Literal[1]) -> str: ...
    @overload
    def passport_number(self, count: int) -> str | list[str]: ...
    ...
    @overload
    def drivers_license(self, count: Literal[1]) -> str: ...
    @overload
    def drivers_license(self, count: int) -> str | list[str]: ...
    ...
    @overload
    def national_id(self, count: Literal[1]) -> str: ...
    @overload
    def national_id(self, count: int) -> str | list[str]: ...
